              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  <DialogContent style={{ minHeight: '600px' }}>
                    <DialogContentText>
                      {codeProject && <MobilePDFReader url={`/prospektus/${codeProject}.pdf`} overflow={'none'} scale={'auto'} isShowFooter={false} isShowHeader={false} />}
                    </DialogContentText>
                  </DialogContent>
                </Dialog>
              </Grid>
      ...
      <Container className="container-project-detail" style={{ marginTop: `5rem` }}>
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <img src={dataProject.mapImageUrl} alt={`Peta Alamat ${nameProject && nameProject[0]}`} title={`Peta Alamat ${nameProject && nameProject[0]}`} id="map-picture" style={{ width: `100%`, marginTop: `2rem` }} />
          </Grid>
        </Grid>
      </Container>
      <hr style={{ marginTop: `3rem`, marginBottom: `3rem` }} />
